...
|-----------|---------|---------------|--------------|-----------------|------------------|
| Required  | 3.126 | 175.8 | **56.2x faster** |
| Email     | 56.95 | 1388 | **24.3x faster** |
| GT/LT     | ~2.152 | ~132.2 | **61.4x faster** |
| MaxLength | 24.55 | 148.8 | **6x faster** |
| Enum      | 3.441 | N/A (unique to govalid)| **govalid exclusive** |
